...
- The spill of the table in `Query` page beyond the visible screen. Just made it scrollable.

## v1.1.0 - 2026/04/16

### Added

- `Query` page, that shows aggregate (sum) monthly expense data.
...
- The layout in `Settings` page.

### Removed

- `Quit` button from the `Record` page.
